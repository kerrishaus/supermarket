    ...
    update(deltaTime)
    {
        ...
        for (const object of this.triggeringEntities)
        {
            if (!this.triggeringEntitiesLastUpdate.includes(object))
                this.parentEntity.dispatchEvent({ "type": "startTrigger", object: object });
            
            this.parentEntity.dispatchEvent({ "type": "trigger", object: object });
        }
        ...
        for (const object of noLongerTriggeringEntities)
            this.parentEntity.dispatchEvent({ "type": "stopTrigger", object: object });
